  ...
  return (
    <section className="w-full bg-[#F3F1EC] py-10 px-6 sm:px-12 md:py-14 text-center flex items-center justify-center select-none">
      <div className="max-w-[800px] mx-auto flex flex-col items-center">
        {/* Main Line */}
        <h2 className="font-serif font-normal text-[20px] min-[375px]:text-[22px] min-[430px]:text-[26px] sm:text-[30px] md:text-[32px] text-[#2E3135] leading-snug tracking-wide">
        ...
        {/* Subtext */}
        <p className="font-sans font-light text-[12px] min-[375px]:text-[13px] min-[430px]:text-[14px] sm:text-[15px] md:text-[16px] text-[#2E3135]/80 leading-relaxed tracking-wider max-w-[640px]">
